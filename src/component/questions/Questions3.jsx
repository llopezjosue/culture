...
class Question3 extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (this.state.valueInput !== prevState.valueInput) {
      //bonne reponse =  Pablo Picasso
      if (this.state.valueInput === "Picasso") {
  ...
  render() {
    ...
    const coverCar = {
      backgroundImage: `url(https://s.ftcdn.net/v2013/pics/all/curated/RKyaEDwp8J7JKeZWQPuOVWvkUjGQfpCx_cover_580.jpg?r=1a0fc22192d0c808b8bb2b9bcfbf4a45b1793687)`,
    };
      ...
      <div>
        <Container fluid>
          ...
          <Row>
            <div className="containerSmall shadow-lg">
              ...
              <div
                ...
                style={this.state.carJosue ? coverCar : cover}
              ></div>

              <div>
                <h2 className="h2Question">
                  <img src={question} alt="question" />
                  Quel fameux peintre a réalisé cet oeuvre ?
                </h2>
              </div>
          ...
          <div className="fixed-tips">
            ...
            >
              ...
              <PopoverBody>Une marque de voiture célèbre</PopoverBody>
            </UncontrolledPopover>
          </div>
        </Container>
        <div className="fixed-solution ">
          ...
          <UncontrolledPopover trigger="legacy" placement="bottom" target="solution">
            ...
            <PopoverBody>Picasso </PopoverBody>
          </UncontrolledPopover>
        </div>
      </div>
    );
