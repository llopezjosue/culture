        ...
        <Container fluid>
          ...
          <Row>
            <div className="containerSmall shadow-lg">
              ...
              <div className="container-image1" style={cover}></div>

              <div>
                <h2 className="h2Question">
                  <img src={question} alt="question" />
                  Dans quel musée est conservé ce célèbre tableau ?
                </h2>
              </div>
          ...
          <div className="fixed-tips">
            ...
            >
              ...
              <PopoverBody>Dans un célèbre Musée français</PopoverBody>
            </UncontrolledPopover>
          </div>
          <div className="fixed-solution ">
            ...
            <UncontrolledPopover trigger="legacy" placement="bottom" target="solution">
              ...
              <PopoverBody>le Louvre</PopoverBody>
            </UncontrolledPopover>
          </div>
        </Container>
      </div>
